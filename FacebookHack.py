...
sys.stdout.write('\x1b]2; [SlicKSlickMercy] GIFT\x07')
#-----(user argent)---------#
user = []
ugen2=[]
ugen=[]
...
def Main():
    ...
    if TAYBUL in ['1']:
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100084310221946')
    elif TAYBUL in ['3']:
